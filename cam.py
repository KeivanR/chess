...
while(True):
    ...
    for rect in rects:
        ...
        try:
            ...
            b2 = np.argmax(b[1])
            b4 = np.argmin(b[1])
            lr = draw_eye( (a[1][a4], a[0][a4]),(a[1][a2], a[0][a2]), gray,img)
            rr = draw_eye( (mid+b[1][b4], b[0][b4]), (mid+b[1][b2], b[0][b2]),gray,img)
            cv2.line(img, (a[1][a2], a[0][a2]), (a[1][a4], a[0][a4]), (0, 255, 0), 1)
            cv2.line(img, (mid+b[1][b2], b[0][b2]), (mid+b[1][b4], b[0][b4]), (0, 255, 0), 1)
            cv2.line(img, (int(4*(lr+rr)*mid-3*mid), 0), (int(4*(lr+rr)*mid-3*mid), thresh.shape[0]), (0, 255, 0), 1)
        except:
            pass
    cv2.imshow('eyes', img)
